/**
 * Created by JackMan on 2019/12/28.
 */
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity style={styles.button_view}
                                  onPress={this.requestCoarseLocationPermission.bind(this)}>
                    <Text style={styles.button_text}>申请定位地址权限</Text>
                </TouchableOpacity>
                <TouchableOpacity style={styles.button_view}
